"""autogenerated by genpy from topokite_monitor/mav_monitor_fast.msg. Do not edit."""
import sys
...
class mav_monitor_fast(genpy.Message):
  _md5sum = "ed8f1573ff9de53fd403ade2f6ec0595"
  _type = "topokite_monitor/mav_monitor_fast"
...
"""
  __slots__ = ['header','rc_channel','control_axes','control_buttons']
  _slot_types = ['std_msgs/Header','uint16[8]','uint16[6]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,rc_channel,control_axes,control_buttons
    ...
    """
    if args or kwds:
      super(mav_monitor_fast, self).__init__(*args, **kwds)
